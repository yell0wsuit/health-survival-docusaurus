...
<BaseUrlImg src="/images/sas-survival/02_camp/image053.webp" />
...
lf the cave faces into the wind, build a screen out from both sides, one slightly behind the other, overlapping them to provide an entrance (a).
...
2 Close up and pull tight. It is possible to make a clove hitch in loops on a rope and to put the whole knot ready-made on to the spar ̱ if you have access to the spar end. Many experienced knot-makers do this. Make a loose clove hitch and slip it off the spar. Lay it down and copy the loops formed by the rope. Slip onto the spar and tighten.
...
3 Frap across the other diagonal, then bring the

rope back over one spar and make two or three circuits of the spars above the upper spar and below the lower.
