...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image001.webp" />
<figcaption class="figure-caption text--center">*Sometimes in a survival situation you can be your own worst enemy – controlling your fear and panic is an important skill*</figcaption>
</figure>
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image003.webp" />
<figcaption class="figure-caption text--center">*To limit risk of infection, corpses of drought-stricken animals need to be removed or destroyed. Burning the bodies may be a sensible option.
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image004.webp" />
<figcaption class="figure-caption text--center">*Wildfires can reach temperatures nearing 800&deg;C (1,470&deg;F). They may spread rapidly, especially if there is a strong wind. Keep calm and
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image005.webp" />
<figcaption class="figure-caption text--center">*When a fire is too large to battle with available resources, call for assistance and leave the building immediately. If fiery passageways
...
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image006.webp" />
<figcaption class="figure-caption">*KEEP IT WHERE YOU CAN REACH IT! DON&rsquo;T keep your fire extinguisher in the boot/trunk &ndash; keep it in the passenger compartment where
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image007.webp" />
<figcaption class="figure-caption text--center">*If ignited, a car&rsquo;s fuel tank could explode, sending flaming pools of burning petroleum around the vicinity. Evacuate your car
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image008.webp" />
<figcaption class="figure-caption text--center">*Protective clothing is a must in any chemical or biological disaster.*</figcaption>
</figure>
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image009.webp" />
<figcaption class="figure-caption text--center">*It is very dangerous to approach a tanker or lorry on fire as the fuel tank could explode. The cargo can also pose a significant risk if it
...
<figure class="figure">
  <BaseUrlImg class="figure-img" src="/images/SASSurvial_image010.webp" />
  <figcaption class="figure-caption text--center">*In a flood, never attempt to drive your car on submerged roadways. Strong currents could sweep your vehicle away, trapping you amid rapidly
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image011.webp" />
<figcaption class="figure-caption text--center">*If you are trapped in a building when flooding begins, move to the highest floors of the structure. If the water level continues to rise you
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image012.webp" />
<figcaption class="figure-caption text--center">*Hurricane Katrina was the costliest hurricane in US history, with estimates on the cost of the damage topping $40bn. When the levee system
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image013.webp" />
<figcaption class="figure-caption text--center">*Hurricanes can reach wind speeds of over 250kph (156mph), causing immense property damage and loss of human life.*</figcaption>
</figure>
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image014.webp" />
<figcaption class="figure-caption text--center">*Among the most violent of the earth&rsquo;s natural phenomena, tornado wind speeds have been estimated at 620kph (385mph). Nearly everything
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image015.webp" />
<figcaption class="figure-caption text--center">*Although being struck by lightning is rare, bolts travel at close to 148,800km (93,000 miles) a second, so if you&rsquo;re outdoors in a storm
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image016.webp" />
<figcaption class="figure-caption text--center">*The 2008 Sichuan earthquake in China decimated scores of buildings and left nearly 70,000 dead in its wake.*</figcaption>
</figure>
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image017.webp" />
<figcaption class="figure-caption text--center">*Erupting volcanoes scatter debris for miles, spew rivers of boiling lava, and can produce clouds of ash which, in the most extreme cases,
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image018.webp" />
<figcaption class="figure-caption text--center">*A volcanic mudflow, known as a lahar.*</figcaption>
</figure>
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image020.webp" />
<figcaption class="figure-caption text--center">*The safest canned foods after a nuclear attack are soups, vegetables and fruits.*</figcaption>
</figure>
...
<figure class="figure">
<BaseUrlImg class="figure-img" src="/images/SASSurvial_image022.webp" />
<figcaption class="figure-caption text--center">*As well as its pretty flowers, lavender has many uses &ndash; its oil is used as an antiseptic and for aromatherapy.*</figcaption>
</figure>
