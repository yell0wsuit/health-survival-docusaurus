...
least)&mdash;wood dust is a long-term health hazard ([see Wood dust](#angle-grinders)). There is also a fire/explosion risk from dust
...
There is a high risk of fire and explosion&mdash;do NOT smoke or use naked flames PARTICULARLY if using oil/solvent-based paints.
:::danger[Warning]
...
insulated with asbestos&mdash;itself very dangerous. Be aware of the risks ([see SAFETY FIRST: Asbestos](/sas-urban/urban-safety-first#asbestos).)
...
light&mdash;if your sight is to be protected AND your skin ([see Welding](#welding)).
